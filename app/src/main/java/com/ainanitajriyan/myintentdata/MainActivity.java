package com.ainanitajriyan.myintentdata;
    ...
    public void onClick(View v){
        switch(v.getId()){
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Ainani Tajriyan Muntaharridwan");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Ainani Tajriyan Muntaharridwan");
                mPerson.setAge(17);
                mPerson.setEmail("ainani.tajriyan80@gmail.com");
